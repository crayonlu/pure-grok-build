...
pub(crate) struct SessionActor {
    ...
    /// Mirrored from `SamplerConfig.supports_vision` at spawn and on every
    /// model switch; read synchronously by the read_file / inline-image
    /// embedding paths to decide whether to attach image pixels.
